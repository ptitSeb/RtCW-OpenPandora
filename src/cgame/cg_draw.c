...
static void CG_DrawCrosshair( void ) {
	...
	#ifdef AUTOAIM
	cg.crossHairStatus = 0;
	if (cg.snap->ps.serverCursorHint == HINT_PLYR_ENEMY )
		cg.crossHairStatus=1;  //----(*SEB*)	added
	if (cg.snap->ps.serverCursorHint == HINT_PLYR_UNKNOWN )
		cg.crossHairStatus=1;
	#endif
